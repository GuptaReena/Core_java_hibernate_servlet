		...
		do {
			...
			case 5:
					...
					if(editBook != null) {
						...
						editBook.setBookPrice(newBookPrice);
							bookService.updateBook(editBook);
							System.out.println("Book Price sucessfully Added !!");
					}
					else {
						System.out.println("******************************");
						System.out.println("Sorry! Book with this Id : "+ editBook + " does not exist");
						System.out.println("******************************");
					}
			...
			case 6:
					...
					if(deleteBook != null) {
						...
						System.out.println("******************************");
						System.out.println("Sorry! Book with this Id : "+ deleteBookId + " does not exist");
						System.out.println("******************************");
					}
