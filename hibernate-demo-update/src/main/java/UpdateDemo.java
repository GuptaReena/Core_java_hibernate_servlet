	...
	public static void main(String[] args) {
		...
		//step 1: Get the session Factory from HibernateUtil
				...
				try(sessionFactory;session){
					...
					System.out.println("Going to fetch the employee with the ID :104 .....");
					EmployeeEntity fetchedEntity = session.get(EmployeeEntity.class, 104);
					...
					//Update the contact
					System.out.println("Update the Employee with the ID:104.....");
