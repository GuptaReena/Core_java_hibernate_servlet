...
//			String updateQuery = "Update person_details set person_id = 102 where person_id = 110";
			
			String deleteQuery = "delete from person_details where person_id = 106 ";
			
//			int rowsAffected1 = stmt.executeUpdate(insertQuery);
//			int rowsAffected = stmt.executeUpdate(updateQuery);
			int rowsAffected2 = stmt.executeUpdate(deleteQuery);
			System.out.println(rowsAffected2 + "rowsAffected... " );
